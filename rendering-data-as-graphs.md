...
- i.	[Setting up an OAuth application]()
- ii.	[Fetching repository information]()
- iii.	[Visualizing language counts]()
- iv.	[Combining different API calls]()
...
visualize that information in a couple of different ways using the [D3.js](http://d3js.org/) library. To
...
check out [“D3 for Mortals”](http://www.recursion.org/d3-for-mere-mortals/).
...
has the greatest number of bytes written across all our code. A [treemap](http://bl.ocks.org/mbostock/4063582)
...
call [the language listing API method](https://developer.github.com/v3/repos/#list-languages):
...
(For more information on D3 tree map magic, check out [this simple tutorial](https://developer.github.com/v3/repos/#list-languages).)
